        ...
        <div className="flex items-center justify-between">
          ...
          <ul className="flex items-center space-x-4 m-0">
            ...
            {session ? (
              ...
              <Link
                href="/login"
                className="inline-flex items-center justify-center px-3 py-1 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 transition text-sm font-medium shadow"
